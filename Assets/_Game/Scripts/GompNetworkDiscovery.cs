...
public class GompNetworkDiscovery : NetworkDiscoveryBase<DiscoveryRequest, DiscoveryResponse>
{
    [SerializeField] private GompNetworkManager _networkManager;
    ...
    protected override DiscoveryResponse ProcessRequest(DiscoveryRequest request, IPEndPoint endpoint) 
    {
        return new DiscoveryResponse
        {
            ...
            hostName = PlayerPrefs.GetString(PlayerNicknameUI.PREFS_PLAYER_NAME),
            isFull = _networkManager.PlayerCount == 2
        };
    }
